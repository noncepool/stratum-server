...
parser.add_argument('--password', dest='password', type=str, default='rascal', help='admin password from Stratum server config')
parser.add_argument('--host', dest='host', type=str, default='localhost', help='hostname of Stratum mining instance')
parser.add_argument('--port', dest='port', type=int, default=4050, help='port of Stratum mining instance')
